...
def test_high_digits() :
  assert reader(test_8) == ({"C8H18":["C","H"],"O2":["O"]},{"CO2":["C","O"],"H2O":["H","O"]},{"C":8,"H":18,"O":2},{"C":1,"O":2,"H":2,"O":1})

def test_high_bracket_double_replacement() :
  assert reader(test_9) == ({"(NH4)3PO4":["N","H","P","O"], "Mg(CH3COO)2":["Mg","C","H","C","O","O"]},{"Mg3(PO4)2":["Mg","P","O"],"NH4CH3COO":["N","H","C","H","C","O","O"]},{"N":3,"H":12,"P":1,"O":4,"Mg":1,"C":2,"H":6,"C":2,"O":2,"O":2},{ "Mg":3,"P":2,"O":8,"N":1,"H":4,"C":1,"H":3,"C":1,"O":1,"O":1})